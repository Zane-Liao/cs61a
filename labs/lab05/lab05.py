...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    # Here are some of my thoughts. Alought they are wrong, I still want to record them. Same as below. 
    # make_closer_city = (lat, lon)
    # if distance(make_closer_city, city_a) > distance(make_closer_city, city_b):
    ...
    distance_a = distance(city_a, oriented_city)
    distance_b = distance(city_b, oriented_city)
...
# if index % 2 == 0 -> [index//2] else != 0 -> [1 * len(deck)//2 + index//2]
